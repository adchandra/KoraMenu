  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            const SizedBox(height: 50), // Spacing di atas
            Center(
              child: Text(
            ...
            const SizedBox(height: 40), // Spacing di bawah judul
            ...
            const SizedBox(height: 20), // Spacing di antara TextField
            ...
            const SizedBox(height: 30), // Spacing di bawah password field
            ...
            const SizedBox(height: 10), // Spacing di bawah tombol
          ],
        ),
      ),
    );
